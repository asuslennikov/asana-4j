package ru.jewelline.request.http.modifiers;
...
public interface RequestModifier {
     ...
     * {@link ModifiersChain#next(HttpRequestBuilder, HttpMethod)}, but if it is required by logic of your modifier,
     * you can stop further processing. There is no guarantee that next modifier will be called immediately after the
     * {@link ModifiersChain#next(HttpRequestBuilder, HttpMethod)} call. For now it is true, but in future this call
     ...
     */
    void modify(HttpRequestBuilder requestBuilder, HttpMethod httpMethod, ModifiersChain modifiersChain);
}
