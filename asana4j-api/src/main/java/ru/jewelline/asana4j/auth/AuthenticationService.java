...
public interface AuthenticationService {
    ...
    /**
     * This method provides a {@link java.lang.String} value for 'Authorization' header in your request. <br />
     * <ul>Examples:
     ...
     * based on pre-filled properties, see {@link #setAuthenticationProperty(String, String)}
     *
     ...
     *
     * @param name  authentication property name
     * @param value authentication property value
     */
    void setAuthenticationProperty(String name, String value);

    /**
     * This method provides access by property name for authorization parameters,
     * which were set by {@link #setAuthenticationProperty(String, String)}
     *
     * @param name authentication property name
     ...
     */
    String getAuthenticationProperty(String name);
