...
import ru.jewelline.common.HttpResponse;
...
class ApiResponseImpl implements ApiResponse {
    ...
    private final HttpResponse<ByteArrayOutputStream> httpResponse;

    public ApiResponseImpl(HttpResponse<ByteArrayOutputStream> httpResponse) {
