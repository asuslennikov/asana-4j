...
public interface JsonEntity extends SerializableEntity {
     ...
     * because it highly depends on {@link ru.jewelline.request.http.HttpRequestBuilder} logic (for example the
     * {@link ru.jewelline.request.http.HttpRequestBuilder#setEntity(SerializableEntity)}) can create stateful wrapper)
